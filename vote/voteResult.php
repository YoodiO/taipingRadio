...
<div class="card bg-light text-break">
    <div class="card-body">
        <h5 class="card-title">
            <?php echo $row['seven'];echo "|".$sevenAll."/".$allUser;?>
        </h5>
        <div class="progress">
            <div class="progress-bar progress-bar-striped progress-bar-animated" style="width:<?php echo $sevenAll/$allUser*100;?>%"></div>
        </div>
    </div>
</div>
<div class="card bg-light text-break">
